 ...
 * @author mmeent
 *
 * This interface includes the registry of PLAYER_MAP.
 * If an non-registered user is requested, it will create a new one.
 */
public interface Player {
    public static Map<String, Player> PLAYER_MAP = new HashMap<String, Player>();
    ...
    /**
     * Get a player by just the name. This function is preferred,
     * since the ID is not checked at any of the functions.
